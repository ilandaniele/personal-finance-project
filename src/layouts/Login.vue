  ...
  async created()
  {
    ...
    methods: {  
      ...
      intentar_iniciar_sesion_facebook()
      {
        ...
        @mjr= me parece que para poder habilitar esto necesitamos que la applicacion este en produccion o al menos en el serbidor corriendo con su dominio designado*/
